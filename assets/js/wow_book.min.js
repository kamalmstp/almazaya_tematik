...
this.elem.appendTo(this._lightboxBookContainer);this.opts.toolbar&&(this.opts.toolbarParent=this._lightboxElem,this._isMobile&&(this.opts.toolbarPosition="bottom"));var b=this;e(a).on("click.wowbook",function(){b.showLightbox()});e("<a href='' class='wowbook-close'>\u2715</a>").appendTo(this._lightboxElem).on("click.wowbook",function(){b.hideLightbox()});e(document).on("keydown.wowbook.lightbox",function(a){b.lightboxOn&&(e(a.target).filter("input, textarea, select").length||27===a.which&&b.hideLightbox())})},
